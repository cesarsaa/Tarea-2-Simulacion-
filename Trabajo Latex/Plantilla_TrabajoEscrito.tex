...
\section{Situación 6}
~\\ Al realizar la simulación para cada una de las distribuciones mencionadas, se observa como al cambiar el valor del parametro de referencia la grafica se va moviendo, haciéndose mas ancha y decreciendo. 
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=10cm]{Figuras/Rplot61.png}
        \caption{Simulación para las variables aleatorias Binomial y Poisson}
        \label{fig:Densidad}
    \end{center}
\end{figure}
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=10cm]{Figuras/Rplot62.png}
        \caption{Simulación para las variables aleatorias Binomial Negativa y Normal}
        \label{fig:Densidad}
    \end{center}
\end{figure}
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=10cm]{Figuras/Rplot63.png}
        \caption{Simulación para las variables aleatorias Gamma y Weibull}
        \label{fig:Densidad}
    \end{center}
\end{figure}
...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=13cm]{Figuras/Rplot71.png}
        \caption{Simulación para las variables aleatorias Binomial, Poisson y Binomial Negativa}
        \label{fig:Densidad}
    \end{center}
\end{figure}
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=13cm]{Figuras/Rplot72.png}
        \caption{Simulación para las variables aleatorias Normal, Gamma y Weibull}
        \label{fig:Densidad}
    \end{center}
\end{figure}
...
~\begin{itemize}
\item\textbf {B. P. Demidowitsch. I. A. Maron, E. S. Schuwalowa. Métodos numéricos de análisis. Editorial Paraninfo (1980)}
\item\textbf { http://www.bdigital.unal.edu.co/4748/2/nelcyyazminninoalfonso.2011.parte2.pdf}
\item\textbf { https://www.uam.es/personalpdi/ciencias/carlosp/html/pid/montecarlo.html}
\item\textbf { http://www.estadisticaparatodos.es/taller/cumpleanos/cumpleanos.html}
\end{itemize}
...
par(mfrow=c(2,2))
barplot(matriz6, main="Binomial Negativa (100,0.5)", xlab="Numero de Simulaciones", ylab="", 
col="royalblue4")
barplot(matriz7, main="Binomial Negativa (100,0.8)", xlab="Numero de Simulaciones", ylab="", 
col="royalblue4")
...
plot(matriz6, main="Binomial Negativa", xlab="Numero de Simulaciones", ylab="", 
col="royalblue4", type="s", pch=9)
plot(matriz7, main="Binomial Negativa", xlab="Numero de Simulaciones", ylab="",
 col="royalblue4", type="s", pch=9)
#---Normal---#
Nsim5=100
matriz8=matrix(200)
...
baraja <- c('AC','AD','AP','AT','2C','2D','2P','2T','3C','3D','3P','3T','4C','4D','4P','4T',
            ...
            '9C','9D','9P','9T','10C','10D','10P','10T','JC','JD','JP','JT',
            'KC','KD','KP','KT','QC','QD','QP','QT')
sample(baraja,5,F)
